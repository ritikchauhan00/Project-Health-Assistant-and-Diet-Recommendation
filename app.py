...
activity=st.sidebar.selectbox("Activity",["Sedentary",
                     ...
                     "Very Active",
                     "Extra Active"])
aim=st.sidebar.selectbox("Aim",["weight maintainance","weight loss","weight gain"])
diet_type=st.sidebar.selectbox("Deit Type",["Vegeterain","Non Vegeterain"])
allergies=st.sidebar.selectbox("Alleriges",["Alleriges","None"])
##---------------------------------------------------------------------------------##
...
if tab1:
        ...
        if client:
            with st.spinner("Creating Diet"):
                try:
                    ...
                    promt=f"""You are a helpful AI nutrition assistant.
    ...
    if st.button("Ask AI"):
        ...
        context="\n\n".join([doc.page_content for doc in docs])
        prompt="""You are an AI health and nutrition
